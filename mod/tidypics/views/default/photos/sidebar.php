...
elgg_register_menu_item('page', array('name' => 'A10_tiypics_albums',
									  'text' => elgg_echo('album:all'),
									  'href' => $base . 'all',
									  'section' => 'A'));


elgg_register_menu_item('page', array('name' => 'A20_tiypics_siteimages',
...
if ($page == 'upload') {
        ...
        elgg_register_menu_item('page', array('name' => 'A50_tiypics_mostviewed',
