...
$english =  array(
		...
		'tidypics:delete_image:success' => 'The image-entity was deleted.',
		...
		'album:feature' => "Feature",
		'album:unfeature' => "Unfeature",
		'album:featured' => "Mark the album as featured",
		'album:unfeatured' => "Mark the album unfeatured",
		
		// Forms
		'album:title' => "Title",
		'album:desc' => "Description",
		'album:tags' => "Tags",
		'image:back2album' => 'Back to album',
...
%s',
		...
		'tidypics:noimages' => "Please select one or more photos.",
		...
		'tidypics:deletefailed' => "Could not delete.",
		...
		'album:error' => "Error creating the album.",
		'album:uploadfailed' => "Could not save your album.",
		'album:deletefailed' => "Could not delete your album.",
		'album:blank' => "Please give this album a title.",
		'album:invalid_album' => 'Invalid album',
		'album:cannot_save_cover_image' => 'Could not save cover image.',

		'image:downloadfailed' => "This photo is not available.",
		...
		'album:titletoolong' => 'Album title is too long',
		'album:desptoolong' => 'Album description is too long',
		'photo:titletoolong' => 'Photo title is too long',
		'photo:desptoolong' => 'Photo description is too long',
		'photo:tagstoolong' => 'Photo tags are too long',
