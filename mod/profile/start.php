...
function profile_page_handler($page) {
	...
	if(elgg_get_viewtype() == 'mobile' && $action == 'view'){
		require elgg_get_plugins_path()."profile/pages/profile/view.php";
		return true;
	}
...
function profile_override_avatar_url($hook, $entity_type, $return_value, $params) {
	...
	try {
		...
		elgg_log("ZHError Unable to get profile icon for user with GUID $user_guid", 'ERROR');
