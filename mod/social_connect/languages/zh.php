...
$chinese = array(
	...
	'social_connect:register:bad' => 'Sorry，无法通过%s注册',
	'social_connect:register:ok' => '成功通过客官您的%s帐号创建了新的51招呼帐号.',
	'social_connect:connect:ok' => '成功将客官您的%s帐号绑定到了您的51招呼帐号.',
	'social_connect:connect:emailnotfound' => '客官您输入的邮箱%s还没有注册到51招呼',
	'social_connect:login:ok' => '成功通过%s登录',
	'social_connect:login:bad' => 'Sorry，无法通过%s登录',
	'social_connect:authenticate:loading' => '加载中...',
	'social_connect:authenticate:contacting' => '连接到<b>%s</b>, 请稍等...',
	// Email notifications
	'email:social_connect:subject' => '成功通过客官您的%s帐号创建了新的51招呼帐号',
	'email:social_connect:body' => "非常感谢客官的注册!\n\n亲爱的客官: %s\n\n系统生成密码: %s\n\n客官可以用这个密码登录，然后到您的个人资料页面更改密码.",
