...
$english = array(
	...
	'email:validate:subject' => "Hi %s please confirm your email address for %s",
	'email:validate:body' => "Dear %s,

Welcome! We are so happy that you are joining us!
You just need to confirm your email address before you can find new friends and have fun at 51zhaohu, 
Please confirm your email address by clicking on the link below:
%s
If you can't click on the link, copy and paste it to your browser manually.
After this, how about go to <a href='%s'>your profile page</a> and fill some information to let people know how awesome you are!
",
